...
//            return false;
    ...
    handlers.unit_data = function (payload) {
        ...
        model.itemDetails[tac_nuke_id] = new UnitDetailModel({ name: 'Tactical Ant', description: 'Long range ant missile - High damage, low AOE',  cost: 9500, sicon: siconFor(tac_nuke_id) });
        model.itemDetails[nuke_id] = new UnitDetailModel({ name: 'OHM Wrecker', description: 'Long range ant warhead - high damage high cost',  cost: 41000, sicon: siconFor(nuke_id) });
        model.itemDetails[anti_nuke_id] = new UnitDetailModel({ name: 'SR-24 -Shield- Ant Defense', description: 'Anti-Ant - Intercepts incoming nuclear ant missiles.', cost: 8750, sicon: siconFor(anti_nuke_id) });
    };
